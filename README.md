...
- Run Command:  
```console 
newman run StudentDetailsCollection.postman_collection.json -e StudentDetailsEnvironment.postman_environment.json 
```
- Run Command for Report: 
```console 
newman run StudentDetailsCollection.postman_collection.json -e StudentDetailsEnvironment.postman_environment.json -r cli,htmlextra
```
...
![Newman Report Summary](summary_report.png)